...
const APPLY_SAVE_BEHAVIORS = new Set([
  "leaveUnsaved",
...
function validateOptions(raw = {}) {
  ...
  const applySaveBehavior =
    raw.applySaveBehavior === undefined
      ? "leaveUnsaved"
      : raw.applySaveBehavior;
  ...
  if (!APPLY_SAVE_BEHAVIORS.has(applySaveBehavior)) {
    throw new TypeError(`Unsupported Apply save behavior: ${applySaveBehavior}`);
  }
